...
const CONTENT: Record<string, { title: string; sections: { heading: string; body: string }[] }> = {
  ...
  faq: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Seleccioná el país o ciudad, elegí tu tren y tocá "Comprar". Serás redirigido a Trainline, operador certificado que gestiona el pago de forma segura. WoW Train nunca toca ni procesa tu tarjeta.',
      },
      {
      ...
      },
      {
        ...
        body: 'Sí, la app es gratuita. WoW Train es un afiliado tecnológico de Trainline. Podemos cobrar una comisión sobre los billetes vendidos, sin costo adicional para el usuario.',
      },
      {
  ...
  terms: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'WoW Train es una aplicación de información ferroviaria y plataforma de afiliación tecnológica. Facilita el acceso a horarios GTFS públicos y redirige a operadores certificados (Trainline) para la compra de billetes.',
      },
      {
        heading: '3. Relación de afiliación',
        body: 'WoW Train actúa exclusivamente como "Front-End Afiliado Tecnológico". Trainline Ltd. actúa como Merchant of Record (MoR) en todas las transacciones. WoW Train no es parte de ningún contrato de transporte ni de compraventa de billetes.',
      },
      {
  ...
  privacy: {
    ...
    sections: [
      ...
      {
        heading: 'Pagos',
        body: 'Los pagos se procesan íntegramente por Trainline Ltd. (Merchant of Record). WoW Train nunca recibe, toca ni almacena datos de tarjeta de crédito o débito. Cumplimiento PCI-DSS delegado completamente al MoR.',
      },
      {
        heading: 'Datos del pasajero en checkout',
        body: 'Nombre, documento y email del pasajero se ingresan directamente en el formulario del operador (Trainline) y se mantienen en RAM solo durante la transacción. No se persisten en la App ni en servidores propios.',
      },
      {
        heading: 'Terceros',
  ...
  security: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Toda la gestión de pagos recae en Trainline Ltd., certificado bajo el estándar PCI-DSS. WoW Train es un intermediario de interfaz exclusivamente y nunca recibe datos de pago.',
      },
      {
